...
<!--
In [Lecture 4[(../lectures/lecture04.qmd) and [Lecture 5](../lectures/lecture05.qmd), we used the [**hoopR**](https://hoopr.sportsdataverse.org) package to scrape NBA play-by-play data, which we then used to estimate adjusted plus/minus.
-->
