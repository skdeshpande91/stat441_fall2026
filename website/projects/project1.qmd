...
In [Lecture 4](../lectures/lecture04.qmd) and [Lecture 5](../lectures/lecture05.qmd), we worked with NBA play-by-play data scraped using the [**hoopR**](https://hoopr.sportsdataverse.org).
Using that package, you can scrape shot location data.
