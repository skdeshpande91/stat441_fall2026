...
\input{stat441_header}


\begin{document}
\begin{center}
\Large{STAT 441: Advanced Sports Analytics} \\
\large{Fall 2026} \\
...
\textbf{Location \& schedule:} Tuesdays \& Thursdays 8:00am - 9:15am in Morgridge Hall 1524.

\textbf{Mode of instruction:} In-person lectures.

\textbf{Instructor:} Sameer Deshpande. Office Hours: Tuesday 9:30am - 10:45am (Morgridge Hall 5586); Thursday 4:00pm - 5:30pm (Morgridge Hall 5586); and Friday 3:00pm - 4:30pm (Morgridge Hall 5631). 

\textbf{TA}: Zhexuan Liu. 

\textbf{Requisites:} STAT 333 or 340. Details on assumed background are available below.

\textbf{Course website:} \url{https://skdeshpande91.github.io/stat441_fall2026}. %We will also use Canvas and Piazza (please see below for links).

\textbf{Textbook:} There is no required textbook. Please see below for a list of helpful references.

\textbf{Grading:} Grades based on performance on group projects, take-home exercises, and participation.
...
8/31--9/4 & (no meeting) & Overview  \\
9/7 -- 9/11 & Expected Goals I & Expected Goals II \\ 
9/14 -- 9/18 & Adjusted Plus/Minus & Regularized Adjusted Plus/Minus \\
9/21 -- 9/25 & Expected Runs & Wins Above Replacement I \\
9/28 -- 10/2 & WAR II & Multilevel Modeling  \\ % really an intro for multi-level models
10/5 -- 10/9$^{\star}$ & NFL WAR  & Pitch Framing  \\ 
10/12 -- 10/16 & Bradley-Terry Models & Tournament Simulation \\
10/19 -- 10/23 & Plackett-Luce Models & Markov Chains  \\  %Revisiting expected runs
10/26 -- 10/30 & NFL Drive Simulation I & NFL Drive Simulation II \\ % start with big data bowl stuff
11/2 -- 11/6$^{\star}$ & Intro. to tracking data & Intro. to tracking data \\ % Voronoi tessellations + space ownership
11/9 -- 11/13 & Space ownership I & Space ownership II \\  % path planning? 
11/16 -- 11/20 & Forecasting trajectories I & Forecasting trajectories II \\
11/23 -- 11/27 & TBD & Thanksgiving (no meeting) \\
11/30 -- 12/4$^{\star}$ & TBD & TBD  \\
12/7 -- 12/11 & Project Presentations & (no meeting) \\ \hline
\end{tabular}
}
\end{table}
Group project reports and presentation recordings are due on the starred ($^{\star}$) dates: October 9, November 6, and December 4.
...
\textbf{Group Projects}. There will be three group projects. Each project consists of two parts, a written report and a group presentation. The project due dates are October 9, November 6, and December 4.
...
\emph{\textbf{The use of Quarto is highly recommended for preparing the written report.}}
...
Students can earn a total of 20 points for each peer review by (i) completing the provided rubric and (ii) leaving a constructive comment that identifies strengths and areas for potential improvement.
...
\textbf{Exercises}. Students will earn up to 100 points for completing at least \textbf{two} of the exercises posted on the class website. Each exercise extends or replicates analyses performed in lecture. 
To earn full marks, students submit a writeup of their solution (including all relevant code) to the instructor and to contribute to the discussion of the exercise on Piazza. 
To count for credit, exercise solutions must be submitted within one week of the corresponding lecture. 
Specific logistical details will be announced on the first day of class.

\textbf{Participation:} An additional 60 points will be awarded based on participation during class, office hours, and online discussions on Piazza.
...
\begin{center} \url{https://skdeshpande91.github.io/stat441\_fall2026}. \end{center}
We will use Canvas for submitting assignments and completing peer reviews:
\begin{center} TBA \end{center}
...
While the Statistics Department recognizes the potential benefits of AI, its use in academic work can be problematic. In this course, three rules regarding the use of generative AI models will be enforced: 
\begin{enumerate}
