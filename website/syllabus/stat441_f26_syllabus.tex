...
\textbf{Instructor:} Sameer Deshpande. Office Hours: Tuesday 9:30am - 11:00am (Morgridge Hall 5586); Thursday 4:00pm - 6:00pm (Morgridge Hall 5586); and Friday 3:00pm - 4:30pm (Morgridge Hall 5631). 
...
9/7 -- 9/11 & Expected goals (XG) & Building our own XG model \\ 
9/14 -- 9/18 & Adjusted Plus/Minus & Regularized Adjusted Plus/Minus \\
9/21 -- 9/25 & Expected Runs & Wins Above Replacement (WAR) I \\
9/28 -- 10/2 & WAR II & Multilevel modeling  \\ % really an intro for multi-level models
10/5 -- 10/9$^{\star}$ & NFL WAR  & Pitch Framing  \\ 
10/12 -- 10/16 & Bradley-Terry Models & Rankings II \\
10/19 -- 10/23 & Markov Chains I & Markov Chains II  \\  %Revisiting expected runs
10/26 -- 10/30 & Plackett-Luce Models & Simulating Effects of New Rules \\ % start with big data bowl stuff
