---
title: "Lecture 14: Plackett-Luce Models"
format: html
execute: 
  cache: true
---
...
You can download a [CSV file](https://github.com/skdeshpande91/stat441_fall2026/blob/main/data/lecture14/nfl_mock_drafts.csv) containing the data we will analyze from the course's GitHub repository; it contains the results of the first three rounds of several mock drafts[^datalink].
...
target <- "https://raw.githubusercontent.com/skdeshpande91/stat441_fall2026/refs/heads/main/data/lecture14/nfl_mock_drafts.csv"
raw_data <- readr::read_csv(file = target)
