...
![Screenshot of the competitions covered in the public data](figures/lecture02/statsbomb_freecomps.png){width=100% fig-align="center" #fig-statsbomb-freecomps alt="Table showing the competitions available in the free data provided by StatsBomb"}
