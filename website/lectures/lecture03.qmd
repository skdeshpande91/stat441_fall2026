...
![Regression tree](figures/lecture03/regression_tree.png){#fig-tree}

![Step function represented by the tree](figures/lecture03/partition.png){#fig-partition}
...
![Left: True function (pink) and a step function approximation (green). Right: representation of the step function as a regression tree](figures/lecture03/treeapprx_cart.png){#fig-cart-approx}


![As the number of leaves increases (i.e., tree becomes deeper), we obtain more accurate approximations](figures/lecture03/tree_appx_wide.png){#fig-tree-approx}
...
![Complex trees can be represented as sums of simpler trees](figures/lecture03/sum_of_trees.png){#fig-sum-trees}
